...
t.setAttribute('class','h1');
t.textContent='グルメ情報（検索結果は2件)';
...
st.textContent='検索結果1件目';
ul.insertAdjacentElement('beforeend', st);
...
p2.textContent=data.results.shop[0].address;
ul.insertAdjacentElement('beforeend', p2);
let p3=document.createElement('p');
p3.textContent=data.results.shop[0].budget.name;
ul.insertAdjacentElement('beforeend', p3);
let p4=document.createElement('p');
p4.textContent=data.results.shop[0].catch;
ul.insertAdjacentElement('beforeend', p4);
let p5=document.createElement('p');
p5.textContent=data.results.shop[0].genre.name;
ul.insertAdjacentElement('beforeend', p5);
let p6=document.createElement('p');
p6.textContent=data.results.shop[0].open;
ul.insertAdjacentElement('beforeend', p6);
let p7=document.createElement('p');
p7.textContent=data.results.shop[0].station_name;
ul.insertAdjacentElement('beforeend', p7);
let p8=document.createElement('p');
p8.textContent=data.results.shop[0].sub_genre.name;
...
st2.textContent='検索結果2件目';
ul.insertAdjacentElement('beforeend', st2);
let p10=document.createElement('p');
p10.textContent=data.results.shop[1].name;
lu.insertAdjacentElement('beforeend', p10);
let p11=document.createElement('p');
p11.textContent=data.results.shop[1].mobile_access;
lu.insertAdjacentElement('beforeend', p11);
let p12=document.createElement('p');
p12.textContent=data.results.shop[1].address;
lu.insertAdjacentElement('beforeend', p12);
let p13=document.createElement('p');
p13.textContent=data.results.shop[1].budget.name;
lu.insertAdjacentElement('beforeend', p13);
let p14=document.createElement('p');
p14.textContent=data.results.shop[1].catch;
lu.insertAdjacentElement('beforeend', p14);
let p15=document.createElement('p');
p15.textContent=data.results.shop[1].genre.name;
lu.insertAdjacentElement('beforeend', p15);
let p16=document.createElement('p');
p16.textContent=data.results.shop[1].open;
lu.insertAdjacentElement('beforeend', p16);
let p17=document.createElement('p');
p17.textContent=data.results.shop[1].small_area.name;
lu.insertAdjacentElement('beforeend', p17);
let p18=document.createElement('p');
p18.textContent=data.results.shop[1].sub_genre.name;
